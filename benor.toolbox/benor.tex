...
\fl{}\moduleLeftDash\cl{ {\MODULE} benor}\moduleRightDash\cl{}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ {\EXTENDS} Integers ,\, Sequences ,\, FiniteSets}
\fl{}
\fl{ {\CONSTANT} M ,\, F ,\, MAXROUND ,\, INPUT}
\fl{ {\ASSUME} M \.{\in} Nat \.{\land} F \.{<} M}
\fl{ Machines \.{\defeq} 1 \.{\dotdot} M}
\fl{}
\fl{}
\fl{}
\fl{ Rounds \.{\defeq} 1 \.{\dotdot} MAXROUND}
\fl{}
\fl{ {\p@mmalgorithm} BenOr}
 \fl{ {\p@lbrace}}\al{16}{1}{ {\p@variable} AccMsgPhase1 \.{=} \{ \} ,\,
 AccMsgPhase2 \.{=} \{ \} {\p@semicolon}}
\fl{ {\p@define}}
\fl{ {\p@lbrace}}
\fl{}
\fl{}
 \fl{ SentAccMsgsPhase1Count ( n ,\, r )}\al{21}{6}{ \.{\defeq}}\al{21}{7}{ \{
 m}\al{21}{9}{ \.{\in}}\al{21}{10}{ AccMsgPhase1}\al{21}{11}{
 \.{:}}\al{21}{12}{ ( m . node\_id}\al{21}{16}{ \.{\neq}}\al{21}{17}{ n
 )}\al{21}{19}{ \.{\land}}\al{21}{20}{ ( m . round}\al{21}{24}{
 \.{=}}\al{21}{25}{ r ) \}}
 \fl{ SentAccMsgsPhase2Count ( n ,\, r )}\al{22}{6}{ \.{\defeq}}\al{22}{7}{ \{
 m}\al{22}{9}{ \.{\in}}\al{22}{10}{ AccMsgPhase2}\al{22}{11}{
 \.{:}}\al{22}{12}{ ( m . node\_id}\al{22}{16}{ \.{\neq}}\al{22}{17}{ n
 )}\al{22}{19}{ \.{\land}}\al{22}{20}{ ( m . round}\al{22}{24}{
 \.{=}}\al{22}{25}{ r ) \}}
 \fl{ SentAccMsgsPhase1 ( n ,\, r ,\, b )}\al{23}{8}{ \.{\defeq}}\al{23}{9}{
 \{ m}\al{23}{11}{ \.{\in}}\al{23}{12}{ AccMsgPhase1}\al{23}{13}{
 \.{:}}\al{23}{14}{ ( m . node\_id}\al{23}{18}{ \.{\neq}}\al{23}{19}{ n
 )}\al{23}{21}{ \.{\land}}\al{23}{22}{ ( m . round}\al{23}{26}{
 \.{=}}\al{23}{27}{ r )}\al{23}{29}{ \.{\land}}\al{23}{30}{ ( m .
 val}\al{23}{34}{ \.{=}}\al{23}{35}{ b ) \}}
 \fl{ SentAccMsgsPhase2 ( n ,\, r ,\, b )}\al{24}{8}{ \.{\defeq}}\al{24}{9}{
 \{ m}\al{24}{11}{ \.{\in}}\al{24}{12}{ AccMsgPhase2}\al{24}{13}{
 \.{:}}\al{24}{14}{ ( m . node\_id}\al{24}{18}{ \.{\neq}}\al{24}{19}{ n
 )}\al{24}{21}{ \.{\land}}\al{24}{22}{ ( m . round}\al{24}{26}{
 \.{=}}\al{24}{27}{ r )}\al{24}{29}{ \.{\land}}\al{24}{30}{ ( m .
 val}\al{24}{34}{ \.{=}}\al{24}{35}{ b ) \}}
\fl{ {\p@rbrace}}
\fl{}
\fl{}
\fl{ {\p@macro} SendP1 {\p@lparen} n ,\, r ,\, b {\p@rparen}}
\fl{ {\p@lbrace}}
 \fl{ AccMsgPhase1 \.{:=} AccMsgPhase1 \.{\cup} \{ [ node\_id \.{\mapsto} n
 ,\, round \.{\mapsto} r ,\, val \.{\mapsto} b ] \} {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{}
\fl{ {\p@macro} CollectP1 {\p@lparen} n ,\, r {\p@rparen}}
\fl{ {\p@lbrace}}
\fl{}
 \fl{ {\p@await} ( Cardinality ( SentAccMsgsPhase1Count ( n ,\, r ) ) \.{>} (
 M \.{-} F \.{-} 1 ) ) {\p@semicolon}}
\fl{}
 \fl{ {\p@if} {\p@lparen}}\al{38}{2}{ Cardinality ( SentAccMsgsPhase1 ( n ,\,
 r ,\, 1 ) ) \.{*} 2 \.{>} ( M ) {\p@rparen} {\p@lbrace}}
\fl{ x \.{:=} 1 {\p@semicolon}}
 \fl{ {\p@rbrace}}\al{40}{1}{ {\p@else} {\p@if} {\p@lparen} Cardinality (
 SentAccMsgsPhase1 ( n ,\, r ,\, 0 ) ) \.{*} 2 \.{>} ( M ) {\p@rparen}
 {\p@lbrace}}
\fl{ x \.{:=} 0 {\p@semicolon}}
\fl{ {\p@rbrace}}\al{42}{1}{ {\p@else} {\p@lbrace}}
\fl{ x \.{:=} \.{-} 1 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ phase1\_complete \.{:=} {\TRUE} {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{}
\fl{}
\fl{ {\p@macro} SendP2 {\p@lparen} n ,\, r ,\, b {\p@rparen}}
\fl{ {\p@lbrace}}
 \fl{ AccMsgPhase2 \.{:=} AccMsgPhase2 \.{\cup} \{ [ node\_id \.{\mapsto} n
 ,\, round \.{\mapsto} r ,\, val \.{\mapsto} b ] \} {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{}
\fl{}
\fl{ {\p@macro} CollectP2 {\p@lparen} n ,\, r {\p@rparen}}
\fl{ {\p@lbrace}}
 \fl{ {\p@await} ( Cardinality ( SentAccMsgsPhase2Count ( n ,\, r ) ) \.{>} (
 M \.{-} F \.{-} 1 ) ) {\p@semicolon}}
 \fl{ {\p@if} {\p@lparen}}\al{58}{2}{ Cardinality ( SentAccMsgsPhase2 ( n ,\,
 r ,\, 0 ) ) \.{\geq} ( F \.{+} 1 ) {\p@rparen} {\p@lbrace}}
\fl{ x \.{:=} 0 {\p@semicolon}}
 \fl{ {\p@rbrace}}\al{60}{1}{ {\p@else} {\p@if} {\p@lparen} Cardinality (
 SentAccMsgsPhase2 ( n ,\, r ,\, 1 ) ) \.{\geq} ( F \.{+} 1 ) {\p@rparen}
 {\p@lbrace}}
\fl{ x \.{:=} 1 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ phase2\_complete \.{:=} {\TRUE} {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{ {\p@macro} NextRound {\p@lparen} n ,\, r {\p@rparen}}
\fl{ {\p@lbrace}}
 \fl{ {\p@if} {\p@lparen}}\al{67}{2}{ SentAccMsgsPhase2 ( n ,\, r ,\, 1 )
 \.{\neq} \{ \} {\p@rparen} {\p@lbrace}}
\fl{ x \.{:=} 1 {\p@semicolon}}
 \fl{ {\p@rbrace}}\al{69}{1}{ {\p@else} {\p@if} {\p@lparen} SentAccMsgsPhase2
 ( n ,\, r ,\, 0 ) \.{\neq} \{ \} {\p@rparen} {\p@lbrace}}
\fl{ x \.{:=} 0 {\p@semicolon}}
\fl{ {\p@rbrace}}\al{71}{1}{ {\p@else} {\p@lbrace}}
\fl{ x \.{:=} {\CHOOSE} y \.{\in} \{ 0 ,\, 1 \} \.{:} {\TRUE} {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{}
\fl{}
\fl{ {\p@fair} {\p@process} {\p@lparen} l \.{\in} Machines {\p@rparen}}
 \fl{ {\p@variable} n\_id \.{=} self ,\, phase1\_complete \.{=} {\FALSE} ,\,
 phase2\_complete \.{=} {\FALSE} ,\, r \.{=} 1 ,\, decided \.{=} \.{-} 1 ,\,
 x \.{=} INPUT [ self ] {\p@semicolon}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}\.{*}} how to assign the value to
 \ensuremath{val} to each node
}%
}
\fl{ {\p@lbrace}}
 \fl{ P\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} r \.{\leq} MAXROUND
 {\p@rparen} {\p@lbrace}}
\fl{}
 \fl{ P1\@s{.5}\textrm{:}\@s{3}}\al{82}{1}{ SendP1 ( n\_id ,\, r ,\, x
 )}\al{82}{9}{ {\p@semicolon}}
 \fl{ CP1\@s{.5}\textrm{:}\@s{3}}\al{83}{1}{ CollectP1 ( n\_id ,\, r
 )}\al{83}{7}{ {\p@semicolon}}
\fl{}
 \fl{ {\p@if} {\p@lparen}}\al{85}{2}{ phase1\_complete \.{=} {\TRUE}
 {\p@rparen} {\p@lbrace}}
 \fl{ P2\@s{.5}\textrm{:}\@s{3}}\al{86}{1}{ SendP2 ( n\_id ,\, r ,\, x )
 {\p@semicolon}}
\fl{ {\p@rbrace}}\al{87}{1}{ {\p@semicolon}}
 \fl{ CP2\@s{.5}\textrm{:}\@s{3}}\al{88}{1}{ CollectP2 ( n\_id ,\, r )
 {\p@semicolon}}
\fl{}
\fl{}
 \fl{ P2F\@s{.5}\textrm{:}\@s{3}}\al{91}{1}{ {\p@if} {\p@lparen}
 phase2\_complete \.{=} {\TRUE} {\p@rparen} {\p@lbrace}}
 \fl{ {\p@if} {\p@lparen}}\al{92}{2}{ x \.{\in} \{ 0 ,\, 1 \} {\p@rparen}
 {\p@lbrace}}
\fl{ decided \.{:=} x {\p@semicolon}}
\fl{ {\p@rbrace}}\al{94}{1}{ {\p@else} {\p@lbrace}}
\fl{ decided \.{:=} \.{-} 1 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ NextRound ( n\_id ,\, r ) {\p@semicolon}}
\fl{ {\p@rbrace}}\al{98}{1}{ {\p@semicolon}}
\fl{ r \.{:=} r \.{+} 1}\al{99}{5}{ {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}%
\@y{}%
